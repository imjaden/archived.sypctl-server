 ...
 *   https://github.com/helijun/documents/blob/master/plugin/lazyLoad/jquery.lazyload.js
                ...
                if (!this.loaded) {
                    $("<img />")
                        ...
                        .bind("error", function() {
                            ...
                            console.groupEnd()
                            $(self).attr('src', src404).attr('data-errorurl', src)
                        })
                };
            });
