-- ------------------------------------------------
-- database snapshot
-- auto generated: 19-03-18 13:33:55
--
-- host: 127.0.0.1
-- port: 3306
-- username: root
...
call pro_snapshot_method_create_table_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta');
CREATE TABLE IF NOT EXISTS `DATABASE_NAME`.`sys_backup_mysql_meta` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `uuid` varchar(255) NOT NULL COMMENT 'UUID',
...
call pro_snapshot_method_create_table_unless_exists('DATABASE_NAME', 'sys_sms_records');
CREATE TABLE IF NOT EXISTS `DATABASE_NAME`.`sys_sms_records` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
call pro_snapshot_method_create_table_unless_exists('DATABASE_NAME', 'sys_file_backups');
CREATE TABLE IF NOT EXISTS `DATABASE_NAME`.`sys_file_backups` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `uuid` varchar(255) NOT NULL COMMENT 'UUID',
...
call pro_snapshot_method_create_table_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day');
CREATE TABLE IF NOT EXISTS `DATABASE_NAME`.`sys_backup_mysql_day` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `uuid` varchar(255) NOT NULL COMMENT 'UUID',
  `device_name` varchar(255) NOT NULL COMMENT '设备名称',
  `device_uuid` varchar(255) NOT NULL COMMENT '设备 UUID',
...
call pro_snapshot_method_create_table_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs');
CREATE TABLE IF NOT EXISTS `DATABASE_NAME`.`sys_agent_behavior_logs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `uuid` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'UUID',
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'id', 'bigint(20) NOT NULL AUTO_INCREMENT');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'uuid', 'varchar(255) NOT NULL COMMENT "UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'device_name', 'varchar(255) NOT NULL COMMENT "设备名称"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'device_uuid', 'varchar(255) NOT NULL COMMENT "设备 UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'ymd', 'varchar(255) NOT NULL COMMENT "日期 YY/MM/DD"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'database_count', 'varchar(255) DEFAULT NULL COMMENT "实例中所有数据库数量"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'backup_count', 'varchar(255) DEFAULT NULL COMMENT "实例中所有数据库数量"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'backup_size', 'varchar(255) DEFAULT NULL COMMENT "数据库体积(共)"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'backup_duration', 'varchar(255) DEFAULT NULL COMMENT "备份总耗时"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'backup_state', 'varchar(255) DEFAULT NULL COMMENT "备份状态"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'description', 'text COMMENT "描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'created_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_meta', 'updated_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'id', 'bigint(20) NOT NULL AUTO_INCREMENT');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'uuid', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'mobile', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "手机号"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'message', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "短信内容"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'state', 'varchar(255) COLLATE utf8_bin NOT NULL DEFAULT "todo" COMMENT "发送状态, default: todo"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'sms_code', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "响应编号(阿里云)"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'sms_message', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "响应编号(阿里云)"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'sms_total_time', 'float DEFAULT NULL COMMENT "发送耗时"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'sms_request_id', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "请求 ID(阿里云)"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'sms_biz_id', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "BIZ ID(阿里云)"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'creater_name', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "发送人名称"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'creater_uuid', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "发送人uuid/mobile"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'description', 'text COLLATE utf8_bin COMMENT "描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'created_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_sms_records', 'updated_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_file_backups', 'id', 'bigint(20) NOT NULL AUTO_INCREMENT');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_file_backups', 'uuid', 'varchar(255) NOT NULL COMMENT "UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_file_backups', 'file_path', 'varchar(255) NOT NULL COMMENT "文件路径"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_file_backups', 'description', 'varchar(255) DEFAULT NULL COMMENT " 文件描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_file_backups', 'string', 'varchar(255) DEFAULT NULL COMMENT " 文件描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_file_backups', 'created_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_file_backups', 'updated_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'id', 'bigint(20) NOT NULL AUTO_INCREMENT');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'uuid', 'varchar(255) NOT NULL COMMENT "UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'device_name', 'varchar(255) NOT NULL COMMENT "设备名称"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'device_uuid', 'varchar(255) NOT NULL COMMENT "设备 UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'ymd', 'varchar(255) NOT NULL COMMENT "日期 YY/MM/DD"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'host', 'varchar(255) DEFAULT NULL COMMENT "ip"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'port', 'varchar(255) DEFAULT NULL COMMENT "port"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'database_name', 'varchar(255) DEFAULT NULL COMMENT "数据库数量"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'backup_name', 'varchar(255) DEFAULT NULL COMMENT "备份文件"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'backup_size', 'varchar(255) DEFAULT NULL COMMENT "备份体积(压缩)"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'backup_md5', 'varchar(255) DEFAULT NULL COMMENT "备份文件MD5"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'backup_time', 'varchar(255) DEFAULT NULL COMMENT "备份执行时间"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'backup_duration', 'varchar(255) DEFAULT NULL COMMENT "备份耗时"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'backup_state', 'varchar(255) DEFAULT NULL COMMENT "备份路径"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'description', 'text COMMENT "描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'created_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_backup_mysql_day', 'updated_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'id', 'bigint(20) NOT NULL AUTO_INCREMENT');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'uuid', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'device_name', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "设备名称"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'device_uuid', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "设备 UUID"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'behavior', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "行为描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'object_type', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "行为对象类型"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'object_id', 'varchar(255) COLLATE utf8_bin NOT NULL COMMENT "行为对象标识"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'description', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'string', 'varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT "描述"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'created_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_agent_behavior_logs', 'updated_at', 'datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_devices', 'file_backup_list', 'text COMMENT "文件备份列表，JSON 格式"');
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_devices', 'file_backup_config', 'text COMMENT "文件备份列表，JSON 格式"');
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_devices', 'file_backup_monitor', 'text COMMENT "文件备份列表执行结果"');
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_job_templates', 'template_type', 'varchar(255) NOT NULL DEFAULT "script" COMMENT "模板类型"');
