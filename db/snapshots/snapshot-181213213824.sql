-- ------------------------------------------------
-- database snapshot
-- auto generated: 18-12-13 21:38:24
--
-- host: localhost
-- port: 3306
-- username: root
...
CREATE TABLE IF NOT EXISTS `DATABASE_NAME`.`sys_job_groups` (
  ...
  `user_group_uuid` varchar(255) DEFAULT NULL COMMENT '分组 UUID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='任务组表';
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_operation_logs', 'objects', 'text COMMENT "对象"');
...
call pro_snapshot_method_add_column_unless_exists('DATABASE_NAME', 'sys_records', 'device_uuid', 'varchar(255) DEFAULT NULL COMMENT "设备 UUID"');
