-- ------------------------------------------------
-- database snapshot
-- auto generated: 18-12-24 23:02:11
--
-- host: localhost
-- port: 3306
-- username: root
...
update `DATABASE_NAME`.sys_users set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_user_groups set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_apps set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_apps set latest_version_uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_app_groups set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_versions set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_devices set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_device_groups set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_jobs set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_job_groups set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_job_templates set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_services set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_operation_logs set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_records set uuid = replace(uuid(), '-', '') where uuid is null;
update `DATABASE_NAME`.sys_devices as sd left join `DATABASE_NAME`.sys_device_groups as sdg on sd.device_group_id = sdg.id set sd.device_group_uuid = sdg.uuid where sd.device_group_uuid is null;
